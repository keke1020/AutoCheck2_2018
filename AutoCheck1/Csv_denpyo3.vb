        ...
        If type = 0 Then
            ...
            For r1 As Integer = 0 To DGV1.RowCount - 1
                ...
                For checkcodei As Integer = 0 To mCodeArray.Length - 1
                    ...
                    If checkcode(0).ToLower = "ny261-1000-a" Or checkcode(0).ToLower = "ny261-2000-a" Or checkcode(0).ToLower = "ny264-100-4000" Then
                        If checkcode(1) = Int(checkcode(1)) Then
                            ...
                            ElseIf checkcode(0).ToLower = "ny264-100-4000" Then
                ...
                For i As Integer = 0 To mCodeArray.Length - 1
                    ...
                    If ny261_isnagoya Then
                        If haisouKind = "宅配便" And (code(0).ToLower = "ny261-1000-a") Then
                            'weight = "16.66"
                            weight = "25"
                            sp_check = False
                        End If

                        If haisouKind = "宅配便" And (code(0).ToLower = "ny261-2000-a") Then
                            'weight = "33.32"
                            weight = "50"
                            sp_check = False
                        End If

                        If haisouKind = "宅配便" And (code(0).ToLower = "ny264-100-4000") Then
                            'weight = "66.64"
                            weight = "100"
                            sp_check = False
                        End If
                ...
                If DGV1.Item(dH1.IndexOf("マスタ配送"), r1).Value <> "計算不能" Then
                    ...
                    End If
                    If haisouKind = "宅配便" And special_taku2 = True Then
                        DGV1.Item(dH1.IndexOf("発送方法"), r1).Value = "宅配便"
                        DGV1.Item(dH1.IndexOf("データ"), r1).Value = "佐川"
                    End If
        ...
        For r As Integer = 0 To DGV1.RowCount - 1
            ...
            If IsNumeric(binsu) Then
                Select Case True
                    ...
                    Case hassou = "メール便" And souko = HS4.Text
                        LinkLabel27.Text += 1 'CInt(binsu)
                    Case hassou = "定形外" And souko = HS1.Text
                        LinkLabel9.Text += 1 'CInt(binsu)
                    Case hassou = "定形外" And souko = HS2.Text
                        LinkLabel12.Text += 1 'CInt(binsu)
                    Case hassou = "定形外" And souko = HS4.Text
                        LinkLabel13.Text += 1 'CInt(binsu)
                    Case masutahaiso = "ヤマト(陸便)" And souko = HS1.Text
                        LinkLabel31.Text += 1 'CInt(binsu)
                    Case masutahaiso = "ヤマト(船便)" And souko = HS1.Text
                        LinkLabel33.Text += 1 'CInt(binsu)
                    Case masutahaiso = "ヤマト(陸便)" And souko = HS2.Text
                        LinkLabel32.Text += 1 'CInt(binsu)
                    Case masutahaiso = "ヤマト(船便)" And souko = HS2.Text
            ...
            If dgvM(i).RowCount > 0 Then
                ...
                For r As Integer = 0 To dgvM(i).RowCount - 1
                    ...
                    If CheckBox20.Checked = True Or CheckBox25.Checked = True Then
                        ...
                        locationSet.Tables(flagConcat).Rows.Add(kiji2, code, name, line, kiji3)
                    Else
                        locationSet.Tables(nameArray(0)).Rows.Add(kiji2, code, name, line, kiji3)  'GU
                    End If
                Next
